...
namespace BVMMalzeme.BL
{
    public static class BLogic
    {
        ...
        public static bool MüşteriEkle(Musteri m)
        {
            ...
            {
                MessageBox.Show("Hata olutu:" +  ex.Message);
                return false;
            }
        }
        ...
        internal static DataSet MüşteriGetir(string filtre)
        {
            try
            {
                ...
                DataSet ds = DataLayer.MüşteriGetir(filtre, dataSet);
        ...
        internal static DataSet UrunGetir(string filtre)
        {
            try
            {
                ...
                DataSet ds = DataLayer.UrunGetir(filtre, dataSet);
